...
def main():
    ...
    print("\nDocument Scores Berdasarkan BM25:")
    for i, score in enumerate(doc_scores):
        doc_id = list(doc_dict.keys())[i]
        print(f"{doc_id}: Score {score:.4f}")

    from collections import OrderedDict
    def exact_top_k_bm(doc_dict, rank_score, k):
        relevance_scores = {}
        i = 0
    ...
    print("\n Top 3 Documents Berdasarkan BM25:")
    k=3
    top_3_bm = exact_top_k_bm(doc_dict,doc_scores,k)
    for doc, score in top_3_bm.items():
