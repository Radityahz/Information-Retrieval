...
posting_covid = list(inverted_index.get('covid', {}).keys())

# OR pada posting list
result = OR(posting_corona, posting_covid)

# Output hasil pencarian
if result:
    print(f"Query: corona OR covid")
    print(f"Ditemukan di dokumen:")
    for doc_id in result:
        print(f"{doc_names[doc_id]}")
else:
    print(f"Term corona atau covid tidak ditemukan di dokumen manapun.")